...
public class ChatActivity extends AppCompatActivity {
    ...
    ImageView profile_small;
    String ReciverImage, ReciverUID, ReciverName, SenderUID;
    CircleImageView profileImage;
    TextView reciverName;
    FirebaseDatabase database;
    FirebaseAuth firebaseAuth;
    public static String sImage; // 채팅창에서 메세지 보내는 사람의 이미지
    public static String rImage; // 채팅창에서 메세지 받는 사람의 이미지
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager.setStackFromEnd(true); // 넘어가게 해주는 기능?
        messageAdapter.setLayoutManager(linearLayoutManager);


        adater = new MessagesAdater(ChatActivity.this, messagesArrayList);
        messageAdapter.setAdapter(adater);
